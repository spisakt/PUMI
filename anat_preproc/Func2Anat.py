def bbr_workflow(SinkTag="func_preproc", wf_name="func2anat"):
    ...
    analysisflow.connect(myonevol, 'outputspec.func1vol',reg_anatmask_to_func1,'reference')
    ...
    analysisflow.connect(myonevol, 'outputspec.func1vol',reg_anatmask_to_func2,'reference')
    ...
    analysisflow.connect(myonevol, 'outputspec.func1vol', reg_anatmask_to_func3, 'reference')
    ...
    analysisflow.connect(myonevol, 'outputspec.func1vol', reg_anatmask_to_func4, 'reference')
